...
import c o m . o p e n s y m p h o n y . x w o r k 2 . A c t i o n S u p p o r t ;
...
public class LoginAction extends ActionSupport implements SessionAware {
	...
	public String execute(){
		...
		session.put("looginUser",loginDTO);
		...
		if((LoginDTO)session.get("loginUser")).getLoginFlg()){
			...
			session.put("buyItem_name",buyItemDTO.getItemNam());
